...
import { CacheKeyType, CacheOptions, Node } from '../../src/types'
import {
...
export default () => {
  ...
  describe('resolveCacheKey', () => {
    ...
    const cases: Case[] = [
      ...
      // // sessionId, parentType, returnType, fieldName,            parent,   args,     options,     expected
      // [  null,      node(),     ojbect(),   '__resolveReference', withId(), withId(), 'none',      'node-id-parent'],
      // [  null,      node(),     ojbect(),   '__resolveReference', withId(), withId(), 'node',      'node-id-parent'],
      // [  null,      node(),     ojbect(),   '__resolveReference', withId(), withId(), 'parent',    'parent-field-parent'],
      // [  null,      node(),     ojbect(),   '__resolveReference', withId(), withId(), 'fn',        'node-id-fn'],
      // [  null,      node(),     ojbect(),   '__resolveReference', withId(), withId(), 'node-fn',   'node-id-fn'],
      // [  null,      node(),     ojbect(),   '__resolveReference', withId(), withId(), 'parent-fn', 'parent-field-fn'],
      // // sessionId, parentType, returnType, fieldName,            parent,   args,     options,     expected
      // [  null,      node(),     ojbect(),   '__resolveReference', withId(), {}      , 'none',      'node-id-parent'],
      // [  null,      node(),     ojbect(),   '__resolveReference', withId(), {}      , 'node',      'node-id-parent'],
      // [  null,      node(),     ojbect(),   '__resolveReference', withId(), {}      , 'parent',    'parent-field-parent'],
      // [  null,      node(),     ojbect(),   '__resolveReference', withId(), {}      , 'fn',        'node-id-fn'],
      // [  null,      node(),     ojbect(),   '__resolveReference', withId(), {}      , 'node-fn',   'node-id-fn'],
      // [  null,      node(),     ojbect(),   '__resolveReference', withId(), {}      , 'parent-fn', 'parent-field-fn'],
      // // sessionId, parentType, returnType, fieldName,            parent,   args,     options,     expected
      // [  null,      node(),     ojbect(),   '__resolveReference', {}      , withId(), 'none',      'null'],
      // [  null,      node(),     ojbect(),   '__resolveReference', {}      , withId(), 'node',      'null'],
      // [  null,      node(),     ojbect(),   '__resolveReference', {}      , withId(), 'parent',    'null'],
      // [  null,      node(),     ojbect(),   '__resolveReference', {}      , withId(), 'fn',        'node-id-fn'],
      // [  null,      node(),     ojbect(),   '__resolveReference', {}      , withId(), 'node-fn',   'node-id-fn'],
      // [  null,      node(),     ojbect(),   '__resolveReference', {}      , withId(), 'parent-fn', 'parent-field-fn'],
      // // sessionId, parentType, returnType, fieldName,            parent,   args,     options,     expected
      // [  null,      node(),     ojbect(),   '__resolveReference', {}      , {}      , 'none',      'null'],
      // [  null,      node(),     ojbect(),   '__resolveReference', {}      , {}      , 'node',      'null'],
      // [  null,      node(),     ojbect(),   '__resolveReference', {}      , {}      , 'parent',    'null'],
      // [  null,      node(),     ojbect(),   '__resolveReference', {}      , {}      , 'fn',        'node-id-fn'],
      // [  null,      node(),     ojbect(),   '__resolveReference', {}      , {}      , 'node-fn',   'node-id-fn'],
      // [  null,      node(),     ojbect(),   '__resolveReference', {}      , {}      , 'parent-fn', 'parent-field-fn'],
...
// HALF-WAY THROUGH
      ...
      // // sessionId, parentType, returnType, fieldName,            parent,   args,     options,     expected
      // [  null,      object(),   node(),     '__resolveReference', withId(), withId(), 'none',      'node-id-parent'],
      // [  null,      object(),   node(),     '__resolveReference', withId(), withId(), 'node',      'node-id-parent'],
      // [  null,      object(),   node(),     '__resolveReference', withId(), withId(), 'parent',    'parent-field-parent'],
      // [  null,      object(),   node(),     '__resolveReference', withId(), withId(), 'fn',        'node-id-fn'],
      // [  null,      object(),   node(),     '__resolveReference', withId(), withId(), 'node-fn',   'node-id-fn'],
      // [  null,      object(),   node(),     '__resolveReference', withId(), withId(), 'parent-fn', 'parent-field-fn'],
      // // sessionId, parentType, returnType, fieldName,            parent,   args,     options,     expected
      // [  null,      object(),   node(),     '__resolveReference', withId(), {}      , 'none',      'node-id-parent'],
      // [  null,      object(),   node(),     '__resolveReference', withId(), {}      , 'node',      'node-id-parent'],
      // [  null,      object(),   node(),     '__resolveReference', withId(), {}      , 'parent',    'parent-field-parent'],
      // [  null,      object(),   node(),     '__resolveReference', withId(), {}      , 'fn',        'node-id-fn'],
      // [  null,      object(),   node(),     '__resolveReference', withId(), {}      , 'node-fn',   'node-id-fn'],
      // [  null,      object(),   node(),     '__resolveReference', withId(), {}      , 'parent-fn', 'parent-field-fn'],
      // // sessionId, parentType, returnType, fieldName,            parent,   args,     options,     expected
      // [  null,      object(),   node(),     '__resolveReference', {}      , withId(), 'none',      'null'],
      // [  null,      object(),   node(),     '__resolveReference', {}      , withId(), 'node',      'null'],
      // [  null,      object(),   node(),     '__resolveReference', {}      , withId(), 'parent',    'null'],
      // [  null,      object(),   node(),     '__resolveReference', {}      , withId(), 'fn',        'node-id-fn'],
      // [  null,      object(),   node(),     '__resolveReference', {}      , withId(), 'node-fn',   'node-id-fn'],
      // [  null,      object(),   node(),     '__resolveReference', {}      , withId(), 'parent-fn', 'parent-field-fn'],
      // // sessionId, parentType, returnType, fieldName,            parent,   args,     options,     expected
      // [  null,      object(),   node(),     '__resolveReference', {}      , {}      , 'none',      'null'],
      // [  null,      object(),   node(),     '__resolveReference', {}      , {}      , 'node',      'null'],
      // [  null,      object(),   node(),     '__resolveReference', {}      , {}      , 'parent',    'null'],
      // [  null,      object(),   node(),     '__resolveReference', {}      , {}      , 'fn',        'node-id-fn'],
      // [  null,      object(),   node(),     '__resolveReference', {}      , {}      , 'node-fn',   'node-id-fn'],
      // [  null,      object(),   node(),     '__resolveReference', {}      , {}      , 'parent-fn', 'parent-field-fn'],
    ...
    // describe('When there `sessionId` is `null`', () => {
    //   const sessionId = null
    //   describe('When `parentType` is `node`', () => {
    //     const parentType = createGraphQLObjectType(createObjectTypeDefinitionNode())
    //     describe('When `returnType` is a `node`', () => {
    //       const returnType = createGraphQLObjectType(createObjectTypeDefinitionNode())
    //       describe('When `fieldName` is `__resolveReference`', () => {
    //         const fieldName = '__resolveReference'
    //         describe('When parent has id', () => {
    //           const parent = { id: casual.uuid }
    //           describe('When args has id', () => {
    //             const args = { id: casual.uuid }
    //             describe('When no options are provided', () => {
    //               it('should return `node-id` type cache key with parents id', () => {
    //                 expect(
    //                   resolveCacheKey(
    //                     {},
    //                     sessionId,
    ...
    //                     args
    //                   )
    //                 ).toEqual(`${returnType.name}.${parent.id}`)
    //               })
    //             }) // END no options provided
    //             describe('When `options.cacheKeyType` is `node-id`', () => {
    //               it('should return `node-id` type cache key with parents id', () => {
    //                 expect(
    //                   resolveCacheKey(
    //                     { cacheKeyType: 'node-id' },
    //                     sessionId,
    //                     createGraphQLResolveInfo({
    //                       returnType,
    //                       parentType,
    ...
    //                 ).toEqual(`${returnType.name}.${parent.id}`)
    //               })
    //             }) // END cacheKeyType is `node-id`
    //             describe('When `options.cacheKeyType` is `parent-field`', () => {
    //               it('should return `parent-field` type cache key with parents id', () => {
    //                 expect(
    //                   resolveCacheKey(
    //                     {cacheKeyType: 'parent-field'},
    //                     sessionId,
    //                     createGraphQLResolveInfo({
    //                       returnType,
    //                       parentType,
    ...
    //                   )
    //                 ).toEqual(
    //                   `${parentType.name}{${parent.id}}.${fieldName}(${JSON.stringify(
    //                     args
    //                   )})`
    //                 )
    //               })
    //             }) // END cacheKeyType is `parent-field`
    //             describe('When `options.nodeId` is provided', () => {
    //               it('should return `node-id` type cache key with the nodeId resolved by `options.nodeId`', () => {
    //                 const id = casual.uuid
    //                 const nodeId = jest.fn(() => id)
    //                 expect(
    //                   resolveCacheKey(
    ...
    //                     args
    //                   )
    //                 ).toEqual(`${returnType.name}.${id}`)
    //               })
    //             }) // END options.nodeId is provided
    //             describe('When `options.cacheKeyType` is `node-id` and `options.nodeId` is provided', () => {
    //               it('should return `node-id` type cache key with the nodeId resolved by `options.nodeId`', () => {
    //                 const id = casual.uuid
    //                 const nodeId = jest.fn(() => id)
    //                 expect(
    //                   resolveCacheKey(
    //                     { cacheKeyType: 'node-id', nodeId },
    //                     sessionId,
    //                     createGraphQLResolveInfo({
    //                       returnType,
    //                       parentType,
    ...
    //                 ).toEqual(`${returnType.name}.${id}`)
    //               })
    //             }) // END options.cacheKeyType is `node-id` and `options.nodeId` is provided
    //             describe('When `options.cacheKeyType` is `parent-field` and `options.nodeId` is provided', () => {
    //               it('should return `parent-field` type cache key with the nodeId resolved by `options.nodeId`', () => {
    //                 const id = casual.uuid
    //                 const nodeId = jest.fn(() => id)
    //                 expect(
    //                   resolveCacheKey(
    //                     { cacheKeyType: 'parent-field', nodeId },
    //                     sessionId,
    //                     createGraphQLResolveInfo({
    //                       returnType,
    //                       parentType,
    ...
    //                   )
    //                 ).toEqual(
    //                   `${parentType.name}{${id}}.${fieldName}(${JSON.stringify(
    //                     args
    //                   )})`
    //                 )
    //               })
    //             }) // END options.cacheKeyType is `parent-field` and `options.nodeId` is provided
    //           }) // END args has id
    //           describe('When args does NOT have id', () => {
    //             const args = {}
    //             describe('When no options are provided', () => {
    //               it('should return `node-id` type cache key with parents id', () => {
    //                 expect(
    ...
    //               })
    //             }) // END options.cacheKeyType is `parent-field` and `options.nodeId` is provided
    //           }) // END args does NOT have id
    //         }) // END parent has id
    //         describe('When parent does NOT have id', () => {
    //           const parent = {}
    //           describe('When args has id', () => {
    //             const args = { id: casual.uuid }
    //             describe('When no options are provided', () => {
    ...
    //             }) // END options.cacheKeyType is `parent-field` and `options.nodeId` is provided
    //           }) // END args does NOT have id
    //         }) // END parent does NOT have id
    //       }) // END fieldName is `__resolveReference`
    //       describe('When fieldName is NOT `__resolveReference`', () => {
    ...
    //             const args = { id: casual.uuid }
    //             describe('When no options are provided', () => {
    //               it('should return `node-id` type cache key args id', () => {
    //                 expect(
    //                   resolveCacheKey(
    //                     {},
    //                     sessionId,
    ...
    //                     args
    //                   )
    //                 ).toEqual(`${returnType.name}.${args.id}`)
    //               })
    //             }) // END no options provided
    //             describe('When `options.cacheKeyType` is `node-id`', () => {
    //               it('should return `node-id` type cache key args id', () => {
    ...
    //             const args = { id: casual.uuid }
    //             describe('When no options are provided', () => {
    //               it('should return `node-id` type cache key with args id', () => {
    //                 expect(
    //                   resolveCacheKey(
    //                     {},
    //                     sessionId,
    ...
    //           }) // END args does NOT have id
    //         }) // END parent does NOT have id
    //       }) // END fieldName is NOT `__resolveReference`
    //     }) // END returnType is a `node`
    //     describe('When returnType is NOT a `node`', () => {
    //       const returnType = createGraphQLScalarType()
    //       describe('When fieldName is NOT `__resolveReference`', () => {
    //         const fieldName = casual.word
    //         describe('When parent has id', () => {
    //           const parent = { id: casual.uuid }
    ...
    //                     args
    //                   )
    //                 ).toEqual(`${parentType.name}{${parent.id}}.${fieldName}(${JSON.stringify(
    //                   args
    //                 )})`)
    //               })
    //             }) // END no options provided
    ...
    //         }) // END parent does NOT have id
    //       }) // END fieldName is NOT `__resolveReference`
    //     }) // END returnType is NOT a `node`
    //   }) // END parentType is `node`
    //   describe('When parentType is NOT `node`', () => {
    //     const parentType = createGraphQLObjectType()
    //     describe('When returnType is a `node`', () => {
    //       const returnType = createGraphQLObjectType(createObjectTypeDefinitionNode())
    //       describe('When fieldName is NOT `__resolveReference`', () => {
    //         const fieldName = casual.word
    ...
    //             const args = { id: casual.uuid }
    //             describe('When no options are provided', () => {
    //               it('should return `node-id` type cache key with the args id', () => {
    //                 expect(
    //                   resolveCacheKey(
    //                     {},
    //                     sessionId,
    ...
    //       }) // END fieldName is NOT `__resolveReference`
    //     }) // END returnType is a `node`
    //   }) // END parentType is NOT `node`
    // }) // END there `sessionId` is `null`
  }) // END resolveCacheKey
}
